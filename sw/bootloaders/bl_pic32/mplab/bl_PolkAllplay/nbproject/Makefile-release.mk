...
ConfName=release
ImagePath="dist\release\${IMAGE_TYPE}\bl_PolkAllplay.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-release.mk dist/${CND_CONF}/${IMAGE_TYPE}/bl_PolkAllplay.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"

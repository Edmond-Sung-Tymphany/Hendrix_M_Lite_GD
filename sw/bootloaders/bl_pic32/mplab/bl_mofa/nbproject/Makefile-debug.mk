...
ConfName=debug
ImagePath="dist\debug\${IMAGE_TYPE}\bl_mofa.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-debug.mk dist/${CND_CONF}/${IMAGE_TYPE}/bl_mofa.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"

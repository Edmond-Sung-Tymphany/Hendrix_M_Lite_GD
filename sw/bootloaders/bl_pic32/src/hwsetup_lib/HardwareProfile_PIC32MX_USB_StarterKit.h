/**
 * @file      HardwareProfile_PIC32MX_USB_StarterKit.h
 * @brief     Header file for Hardware profile (USB Starter Kit III)
 * @author    Gavin Lee
 * @date      16-Mar-2014
...
#define CPU_OSC_FREQ_HZ (80000000L)
...
#define mLED_Blue           LATDbits.LATD1  // Yellow for USB Starter Kit III
#define mLED_Green          LATDbits.LATD2  

/**
 * @file      interrupt.c
 * @brief     Implement Interrupt service routines
 * @author    Gavin Lee
 * @date      16-Mar-2014
 ...
 * Interrupt Routines                                                        *
 *****************************************************************************/
void __ISR(_TIMER_3_VECTOR, IPL3) _T3Interrupt(void)
{
    timer3_interrupt_handler();
    IFS0bits.T3IF = 0;
}

void __ISR(_UART_2_VECTOR, IPL3) _UART2_Interrupt(void) //UART_CONSOLE
{
    UART_handle_interrupt(UART2);
}

void __ISR(_UART_1_VECTOR, IPL3) _UART1_Interrupt(void) //UART_SAM
{

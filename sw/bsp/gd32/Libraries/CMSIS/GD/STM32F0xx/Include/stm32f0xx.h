...
typedef struct
{
  ...
  __IO uint32_t ACCR;  		/*!< RCC clock control register 2,                                Address offset: 0xF8 */
  __IO uint32_t ARCR; 		/*!< RCC clock control register 2,                                Address offset: 0xFC */
...
#define I2C2_BASE             (APB1PERIPH_BASE + 0x00005800)
																//0x4000 6000 - 0x4000 63FF	USB SRAM 512 bytes  
...
#define ADC1_BASE             (APB2PERIPH_BASE + 0x00012400)
#define ADC_BASE              (APB2PERIPH_BASE + 0x00012708)
#define TIM1_BASE             (APB2PERIPH_BASE + 0x00012C00)
#define SPI1_BASE             (APB2PERIPH_BASE + 0x00013000)
#define USART1_BASE           (APB2PERIPH_BASE + 0x00013800)
#define TIM15_BASE            (APB2PERIPH_BASE + 0x00014000)
#define TIM16_BASE            (APB2PERIPH_BASE + 0x00014400)
#define TIM17_BASE            (APB2PERIPH_BASE + 0x00014800)
...
#define  DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT    ((uint32_t)0x00008000)   /*!< I2C1 SMBUS timeout mode stopped when Core is halted */
#define  DBGMCU_APB1_FZ_DBG_I2C2_SMBUS_TIMEOUT    ((uint32_t)0x00010000)   /*!< I2C2 SMBUS timeout mode stopped when Core is halted */
#define  DBGMCU_APB1_FZ_DBG_I2C3_SMBUS_TIMEOUT    ((uint32_t)0x00020000)   /*!< I2C3 SMBUS timeout mode stopped when Core is halted */
...
#define  PWR_CR_PLS_LEV0                      ((uint16_t)0x0000)     /*!< PVD level 2.2V */
#define  PWR_CR_PLS_LEV1                      ((uint16_t)0x0020)     /*!< PVD level 2.3V */
#define  PWR_CR_PLS_LEV2                      ((uint16_t)0x0040)     /*!< PVD level 2.4V */
#define  PWR_CR_PLS_LEV3                      ((uint16_t)0x0060)     /*!< PVD level 2.5V */
#define  PWR_CR_PLS_LEV4                      ((uint16_t)0x0080)     /*!< PVD level 2.6V */
#define  PWR_CR_PLS_LEV5                      ((uint16_t)0x00A0)     /*!< PVD level 2.7V */
#define  PWR_CR_PLS_LEV6                      ((uint16_t)0x00C0)     /*!< PVD level 2.8V */
#define  PWR_CR_PLS_LEV7                      ((uint16_t)0x00E0)     /*!< PVD level 2.9V */
...
#define  RCC_CFGR_PLLMULL                    ((uint32_t)0x083C0000)        /*!< PLLMUL[3:0] bits (PLL multiplication factor) */
#define  RCC_CFGR_PLLMULL_0                  ((uint32_t)0x00040000)        /*!< Bit 0 */
#define  RCC_CFGR_PLLMULL_1                  ((uint32_t)0x00080000)        /*!< Bit 1 */
#define  RCC_CFGR_PLLMULL_2                  ((uint32_t)0x00100000)        /*!< Bit 2 */
#define  RCC_CFGR_PLLMULL_3                  ((uint32_t)0x00200000)        /*!< Bit 3 */
#define  RCC_CFGR_PLLMULL_4                  ((uint32_t)0x08000000)        /*!< Bit 4 */
...
#define  RCC_APB1RSTR_SPI3RST                ((uint32_t)0x00008000)        /*!< SPI3 clock reset */
...
#define  RCC_GDRSTR_I2C3RST                ((uint32_t)0x00000001)        /*!< I2C 3 clock reset */
...
#define  RCC_ACCRENR_I2C3EN                  ((uint32_t)0x00000001)        /*!< I2C3 clock enable */
...
#define RCC_USBCLKSource_PLLCLK_Div1     		 ((uint32_t)0x00000001)

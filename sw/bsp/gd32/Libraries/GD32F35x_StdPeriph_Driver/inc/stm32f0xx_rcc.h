...
#define RCC_ADCCLK_PCLK2_Div2            ((uint32_t)0x01000000)
#define RCC_ADCCLK_PCLK2_Div4            ((uint32_t)0x01004000)
#define RCC_ADCCLK_PCLK2_Div6            ((uint32_t)0x01008000)
#define RCC_ADCCLK_PCLK2_Div8            ((uint32_t)0x0100C000)

#define IS_RCC_ADCCLK(ADCCLK) (((ADCCLK) == RCC_ADCCLK_HSI14) || ((ADCCLK) == RCC_ADCCLK_PCLK2_Div2) || \
                               ((ADCCLK) == RCC_ADCCLK_PCLK2_Div4) || ((ADCCLK) == RCC_ADCCLK_PCLK2_Div6) || \
							   ((ADCCLK) == RCC_ADCCLK_PCLK2_Div8))
...
#define RCC_ACCRPeriph_I2C3              RCC_ACCRENR_I2C3EN

...
/* ADC VBATE mask */
#define CR2_VBATE_Set				((uint32_t)0x01000000)
#define CR2_VBATE_Reset				((uint32_t)0xFEFFFFFF)
...
/**
  ...
  *     @arg ADC_ExternalTrigInjecConv_T15_TRGO: Timer15 TRGO event selected (for ADC1 and ADC2)
...
void ADC_VBatCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ADC1->CR2 |= CR2_VBATE_Set;
  }
  else
  {
    /* Disable the VBat channel*/
    ADC1->CR2 &= CR2_VBATE_Reset;
  }
}

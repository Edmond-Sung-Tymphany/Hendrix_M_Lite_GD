...
#define USBPREH_BitNumber         0x17
#define CFGR_USBPREH_BB           (PERIPH_BB_BASE + (CFGR_OFFSET * 32) + (USBPREH_BitNumber * 4))
...
/**
  ...
  *         from the HSI14 or APB2 clock (PCLK2).
  *          This parameter can be one of the following values:
  *             @arg RCC_ADCCLK_HSI14: ADC clock = HSI14 (14MHz)
  *             @arg RCC_ADCCLK_PCLK2_Div2: ADC clock = PCLK2/2
  *             @arg RCC_ADCCLK_PCLK2_Div4: ADC clock = PCLK2/4
  *             @arg RCC_ADCCLK_PCLK2_Div6: ADC clock = PCLK2/6
  *             @arg RCC_ADCCLK_PCLK2_Div8: ADC clock = PCLK2/8
  * @retval None
  */
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:  /* PLL used as system clock */
      ...
      pllmull = RCC->CFGR & 0x03C0000;//RCC_CFGR_PLLMULL;
      pllsource = RCC->CFGR & RCC_CFGR_PLLSRC; 
  		//pllmull = ( pllmull >> 18) + 2;
      pllmull = ( pllmull >> 18) + 2+(((RCC->CFGR&0x08000000)>>27)*15);
...
//    RCC_Clocks->USART1CLK_Frequency = RCC_Clocks->PCLK2_Frequency;     
  ...
  if((RCC->CFGR3 & RCC_CFGR3_USART1SW) == RCC_CFGR3_USART1SW_1)
  {
    /* USART1 Clock is LSE Osc. */
    RCC_Clocks->USART1CLK_Frequency = LSE_VALUE;
  }
  else 
  if((RCC->CFGR3 & RCC_CFGR3_USART1SW) == RCC_CFGR3_USART1SW)
  {
...
/**
  ...
  *           @arg RCC_APB1Periph_CEC:    USB clock                              
  * @param  NewState: new state of the specified peripheral clock.
  *          This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
/**
  * @brief  Enables or disables the additional (ACCR) peripheral clock.
  * @note   After reset, the peripheral clock (used for registers read/write access)
  *         is disabled and the application software has to enable this clock before 
  *         using it.
  * @param  RCC_ACCRPeriph: specifies the ACCR peripheral to gates its clock.
  *          This parameter can be any combination of the following values:
  ...
  * @retval None
  */
void RCC_ACCRPeriphClockCmd(uint32_t RCC_ACCRPeriph, FunctionalState NewState)
{
  /* Check the parameters */
//  assert_param(IS_RCC_APB2_PERIPH(RCC_APB2Periph));
//  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  * @brief  Forces or releases additional (ACCR) peripheral reset.
  * @param  RCC_ACCRPeriph: specifies the ACCR peripheral to reset.
  *          This parameter can be any combination of the following values:
  *           @arg RCC_ACCRPeriph_I2C3:   I2C3 clock
  * @param  NewState: new state of the specified peripheral clock.
  *          This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void RCC_ACCRPeriphResetCmd(uint32_t RCC_ACCRPeriph, FunctionalState NewState)
{
  /* Check the parameters */
//  assert_param(IS_RCC_APB1_PERIPH(RCC_APB1Periph));
//  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
//  *(vu32 *) CFGR_USBPREH_BB = RCC_USBCLKSource;
}

...
#define HSE_VALUE    ((uint32_t)EXTERNAL_HIGH_SPEED_OSC_FREQ)
...
#define  RCC_CFGR_PLLSRC_HSI                 ((uint32_t)0x00008000)        /*!< HSI clock is selected as PLL entry clock source */
...
/*!< MCO configuration */
#define  RCC_CFGR_MCO                        ((uint32_t)0xFF000000)        /*!< bits (Microcontroller Clock Output) */
#define  RCC_CFGR_PLLNODIV                   ((uint32_t)0x80000000)
#define  RCC_CFGR_PLLDIV                     ((uint32_t)0x00000000)
#define  RCC_CFGR_MCO_1                      ((uint32_t)0x00000000)        /*!< Bit 1 */
#define  RCC_CFGR_MCO_2                      ((uint32_t)0x10000000)        /*!< Bit 2 */
#define  RCC_CFGR_MCO_4                      ((uint32_t)0x20000000)        /*!< Bit 2 */

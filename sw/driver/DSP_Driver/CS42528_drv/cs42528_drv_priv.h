/**
*  @file      Cs42528_drv_priv.h
*  @brief     This file declares the driver for the Codec CS42528.
*  @author    Edmond
*  @date      10-2016
...
#define REF_VOL_CONTROL_7           0x15
#define REF_VOL_CONTROL_8           0x16
...
#define REF_MIX_CONTROL_PAIR_4        0x1b

...
typedef enum _eLedIndID
{
    ...
    LED_IND_ID_INPUT_AUXIN,  
    LED_IND_ID_INPUT_COAXIAL,
    LED_IND_ID_INPUT_OPTICAL,
    LED_IND_ID_INPUT_HDMI,
    LED_IND_ID_INPUT_HDMI_ARC,
    LED_IND_ID_INPUT_BLUETOOTH,
    LED_IND_ID_INPUT_USB,
    LED_IND_ID_INPUT_CAST,
    LED_IND_ID_ALL_OFF,
    LED_IND_ID_GROUP,
...
typedef enum _eLedMask
{
    LED_MASK_LED_RED            = 1<<(LED_RED),
    LED_MASK_LED_GREEN          = 1<<(LED_GREEN),
    LED_MASK_LED_BLUE           = 1<<(LED_BLUE),
    LED_MASK_LED1_WHITE         = 1<<(LED1_WHITE),
    LED_MASK_LED2_WHITE         = 1<<(LED2_WHITE),
    LED_MASK_LED3_WHITE         = 1<<(LED3_WHITE),
    LED_MASK_LED4_WHITE         = 1<<(LED4_WHITE),
    LED_MASK_LED5_WHITE         = 1<<(LED5_WHITE),
    LED_MASK_LED6_WHITE         = 1<<(LED6_WHITE),
    LED_MASK_LED7_WHITE         = 1<<(LED7_WHITE),
    LED_MASK_LED8_WHITE         = 1<<(LED8_WHITE),
    LED_MASK_LED9_WHITE         = 1<<(LED9_WHITE),   
    LED_MASK_WHITE_LEDS           = (LED_MASK_LED1_WHITE | LED_MASK_LED2_WHITE |
                                     LED_MASK_LED3_WHITE | LED_MASK_LED4_WHITE | LED_MASK_LED5_WHITE | LED_MASK_LED6_WHITE|
                                     LED_MASK_LED7_WHITE | LED_MASK_LED8_WHITE | LED_MASK_LED9_WHITE ),

    LED_MASK_ALL_LEDS           = (LED_MASK_LED_RED | LED_MASK_LED_GREEN | LED_MASK_LED_BLUE | LED_MASK_LED1_WHITE | LED_MASK_LED2_WHITE |
                                   LED_MASK_LED3_WHITE | LED_MASK_LED4_WHITE | LED_MASK_LED5_WHITE | LED_MASK_LED6_WHITE|
                                   LED_MASK_LED7_WHITE | LED_MASK_LED8_WHITE | LED_MASK_LED9_WHITE ),

...
#define MAINAPP_FACTORY_RESET_TIMEOUT_MS         (60*1000) /* Timeout for ASE-TK factory reset, normally need 70 sec */
#define MAINAPP_UPGRADE_TIMEOUT_IN_MS            (60*1000) /* Timeout for ASE-TK upgrade:15 min */

...
static const tGPIOPin gpioAudioPins[] =
{
    ...
    {GPIO_OUT_SYSPWR_ON,        IO_PORT_C,  IO_BIT_5,   GPIO_DIGITAL_OUTPUT,    GPIO_DEFAULT_OUT_LOW,    ODC_DISABLE},  
...
static const stSWi2cDevice_t swi2c_epHDMI_Config = {
    .deviceInfo.deviceID    = EP_HDMI_DEV_ID,
    .deviceInfo.deviceType  = SWI2C_DEV_TYPE,
    .busID = eSWi2cBus_ID2,
    .swi2cSpeed = eSWi2c_SPEED_SLOW,
    .devAddress = 0xc8,
    .delayMSAfterWrite = 0,
    ...
    .vSWi2cSCL_Delay = vSWi2c_SclDelay_Slow,
};

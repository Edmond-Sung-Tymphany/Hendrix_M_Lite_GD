...
#define _Proto_FirmwareUpdate_Chunk_ModuleType_MAX Proto_FirmwareUpdate_Chunk_ModuleType_WPL
#define _Proto_FirmwareUpdate_Chunk_ModuleType_ARRAYSIZE ((Proto_FirmwareUpdate_Chunk_ModuleType)(Proto_FirmwareUpdate_Chunk_ModuleType_WPL+1))
...
#define Proto_FirmwareUpdate_Chunk_init_default  {0}
#define Proto_FirmwareUpdate_ChunkResponse_init_default {0}
#define Proto_FirmwareUpdate_VersionInfo_init_default {{{NULL}, NULL}}
#define Proto_FirmwareUpdate_VersionInfo_Module_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
#define Proto_FirmwareUpdate_WplOption_init_default {0}
#define Proto_FirmwareUpdate_Chunk_init_zero     {0}
#define Proto_FirmwareUpdate_ChunkResponse_init_zero {0}
#define Proto_FirmwareUpdate_VersionInfo_init_zero {{{NULL}, NULL}}
#define Proto_FirmwareUpdate_VersionInfo_Module_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
#define Proto_FirmwareUpdate_WplOption_init_zero {0}
...
extern const pb_field_t Proto_FirmwareUpdate_Chunk_fields[1];
extern const pb_field_t Proto_FirmwareUpdate_ChunkResponse_fields[1];
extern const pb_field_t Proto_FirmwareUpdate_VersionInfo_fields[2];
extern const pb_field_t Proto_FirmwareUpdate_VersionInfo_Module_fields[3];
extern const pb_field_t Proto_FirmwareUpdate_WplOption_fields[1];

/* Maximum encoded size of messages (where known) */
#define Proto_FirmwareUpdate_Chunk_size          0
#define Proto_FirmwareUpdate_ChunkResponse_size  0
...
#define Proto_FirmwareUpdate_WplOption_size      0

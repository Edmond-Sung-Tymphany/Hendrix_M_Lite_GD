...
const pb_field_t Proto_SoundWall_A2Bmode_fields[2] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, Proto_SoundWall_A2Bmode, mode, mode, 0),
    PB_LAST_FIELD
};

const pb_field_t Proto_SoundWall_PowerMode_fields[2] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, Proto_SoundWall_PowerMode, mode, mode, 0),
    PB_LAST_FIELD
};
...
const pb_field_t Proto_SoundWall_MuteMode_fields[2] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, Proto_SoundWall_MuteMode, mode, mode, 0),
    PB_LAST_FIELD
};

...
hwVersionTag hwVersionArray[HW_TYPE_NUM] =
{
    ...
    {"PRE-ES",  3700, 4096}, //HW_TYPE_PRE_ES
};
...
{
    TP_PRINTF("sleep\r\n");
    BSP_BlockingDelayMs(5); //wait print finish, for debug
...
static void PowerDrv_EnablelWakeUpSources()
{
    ...
    RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOC, ENABLE);  // for PC13
    ...
    PowerDrv_SetExtInterrupt(EXTI_PortSourceGPIOC, EXTI_PinSource13,
               EXTI_Line13, EXTI_Trigger_Rising_Falling, EXTI4_15_IRQn, ENABLE);

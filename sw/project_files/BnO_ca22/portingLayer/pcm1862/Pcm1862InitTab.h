...
#include "pcm1862Drv_swi2c_priv.h" //PCM1862_AUTO_GAIN_MAPPING
...
*   define macro
*/
#define ENERGYSENSE_RESUME_LEVEL_ADDR    0x2D
#define ENERGYSENSE_LOSS_LEVEL_ADDR      0x2C

/*
*   define the RESUME or LOSS level coeficients/threshold
*/
#define COEFS_NUM   4
const uint8 ENERGYSENSE_RESUME_COEFS[COEFS_NUM] = {0x00, 0x2E, 0x49, 0x00}; // sig resume level -57dB
const uint8 ENERGYSENSE_LOSS_COEFS[COEFS_NUM]   = {0x00, 0x03, 0x46, 0x00}; // sig loss level -80dB

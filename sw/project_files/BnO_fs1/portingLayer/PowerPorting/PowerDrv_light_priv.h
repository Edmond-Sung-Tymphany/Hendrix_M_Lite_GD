...
#define DC_DEBOUNCE_TIME_MS (500)
...
#define CHARGER_ERROR_PERIOD_COUNT                    (3) // <-- Enlarge debouncing period by increaing this number
...
#define TIME_IS_UP                                    (0)
#define POWER_DRIVER_BATTERY_NO_RESPONSE_CRITICAL_MS  (1000)
#define BATTERY_HAVING_REST_PERIOD_MS                 (10000)

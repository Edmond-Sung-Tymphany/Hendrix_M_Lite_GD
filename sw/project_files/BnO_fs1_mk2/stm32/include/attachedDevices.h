...
#define NUM_OF_ADC_POWER_PIN         2 //= ArraySize(attrAdcPowerPins) of attachedDevices.c
#define NUM_OF_ADC_AUDIO_PIN         4 //= ArraySize(attrAdcPowerPins) of attachedDevices.c
 ...
 *  I2C config
 ******************************************************************************/
#define I2C1_CLK_KHZ (100)
#define I2C2_CLK_KHZ (400)

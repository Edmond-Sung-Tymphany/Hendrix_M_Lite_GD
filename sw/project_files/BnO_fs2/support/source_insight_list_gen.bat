...
call:PrintDirRecursive "%BASE_PATH%\sw\driver\ase_tk_driver"
call:PrintDirRecursive "%BASE_PATH%\sw\driver\audio_driver\stm32"
call:PrintDirRecursive "%BASE_PATH%\sw\driver\audio_driver\stm32\tas5760"
call:PrintDirRecursive "%BASE_PATH%\sw\driver\bluetooth_driver"
call:PrintDirRecursive "%BASE_PATH%\sw\driver\DSP_Driver\adau1451_drv"
...
::Server
call:PrintDirRecursive "%BASE_PATH%\sw\server\ase_tk_server"
...
::Other
call:PrintDirRecursive "%BASE_PATH%\sw\sw\bootloaders\bl_stm32"
...
call:PrintDirRecursive "%BASE_PATH%\sw\driver\key_driver\AzIntegTouchKeyDrv"

::FS2 specific
call:PrintDirRecursive "%BASE_PATH%\sw\project_files\BnO_fs2"
call:PrintDirRecursive "%BASE_PATH%\sw\driver\audio_driver\stm32\pcm1862_v2"

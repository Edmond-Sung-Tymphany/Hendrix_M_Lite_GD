...
{
    {GPIO_IN_SOURCE_KEY,  IO_PORT_A,  IO_BIT_1,  GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE}, // source
...
static const tAdcPinIoAttr attrADCPinsForKey[] =
{
    ...
    {ADC_PIN4, ADC_CHANNEL4,    IO_PORT_A, IO_BIT_4}, // PA4 
    {ADC_PIN5, ADC_CHANNEL5,    IO_PORT_A, IO_BIT_5}, // PA5 
};
...
{   /* key_id         key_ADC_channel  settingID, resolution  deltaBuffer adc threshold */
    {BASS_KNOB_BASE_KEY_ID, ADC_PIN3, SETID_MAX, SETID_MAX, MAX_BASS_STEPS,  100,  ADC_THRESHOLD_RANGE},
    {TREBLE_KNOB_BASE_KEY_ID, ADC_PIN4, SETID_MAX, SETID_MAX, MAX_TREBLE_STEPS,  100,  ADC_THRESHOLD_RANGE},
    {VOLUME_KNOB_BASE_KEY_ID, ADC_PIN5, SETID_MAX, SETID_MAX, MAX_VOLUME_STEPS,  100,  ADC_THRESHOLD_RANGE},
};
...
{
    // amplifier control
    {GPIO_OUT_AMP_W_PDN, IO_PORT_B, IO_BIT_10, GPIO_DIGITAL_OUTPUT, GPIO_DEFAULT_OUT_LOW, ODC_DISABLE}, // TAS5760 SDN : PB10
    {GPIO_OUT_AMP_T_PDN, IO_PORT_B, IO_BIT_2, GPIO_DIGITAL_OUTPUT, GPIO_DEFAULT_OUT_LOW, ODC_DISABLE}, // TPA3118 SDN : PB2
    // dc / power control
    {GPIO_IN_DC_IN_DET, IO_PORT_B, IO_BIT_0, GPIO_DIGITAL_INPUT, GPIO_ACTIVE_FLOATING, ODC_NOT_APPLICABLE},  // PB0
    {GPIO_IN_POWER_KEY, IO_PORT_A,  IO_BIT_2, GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_HIGH,  ODC_NOT_APPLICABLE}, // power key, PA2 -todo: check if GPIO_ACTIVE_HIGH have to be
...
/******************************** hardware version pin **************************/
#ifdef HAS_HW_VERSION_TAG
static const tAdcPinIoAttr attrADCPinsForHwVer[] =
{
    {ADC_PIN9, ADC_CHANNEL9,IO_PORT_B, IO_BIT_1}, // HW version
};

static const tADCDevice ADCConfigForHwVersion =
{
    .deviceInfo.deviceID    = POWER_DEV_ID,
    .deviceInfo.deviceType  = ADC_DEV_TYPE,
    .ADCEnabledPinNum = ArraySize(attrADCPinsForHwVer),
    .pAdcPinIoAttr = attrADCPinsForHwVer
};
#endif
/******************************** hardware version pin **************************/
...
static const tGPIOPin gpioPinsForBT[] =
{
    ...
    {GPIO_OUT_BT_RESET, IO_PORT_A, IO_BIT_12, GPIO_DIGITAL_OUTPUT, GPIO_DEFAULT_OUT_FLOATING, ODC_DISABLE}, // BT RESET, PA12
#else
    {GPIO_OUT_BT_RESET, IO_PORT_A, IO_BIT_12, GPIO_DIGITAL_INPUT, GPIO_ACTIVE_FLOATING, ODC_NOT_APPLICABLE}, // BT RESET, PA12
#endif    
};
...
/* Fender Watermelon board uses TAS5760 & TPA3118 */
...
{
    {GPIO_OUT_AMP_T_MUTE, IO_PORT_A,  IO_BIT_6,  GPIO_DIGITAL_OUTPUT,  GPIO_DEFAULT_OUT_HIGH,  ODC_DISABLE},  // TPA3118 MUTE : PA6
    {GPIO_IN_DSP_TUNING, IO_PORT_B,  IO_BIT_11,  GPIO_DIGITAL_INPUT, GPIO_ACTIVE_HIGH,  ODC_NOT_APPLICABLE}, // PB11 dsp tuning detect
    {GPIO_IN_SHAPE_EQ, IO_PORT_C,  IO_BIT_15,  GPIO_DIGITAL_INPUT, GPIO_ACTIVE_HIGH,  ODC_NOT_APPLICABLE}, // PC15 for shape EQ switch
};

static const tGPIODevice GPIOForAudioConfig =
{

...
// gpio key
#define GPIO_IN_TALK_KEY          GPIO_1
...
#define GPIO_IN_BAT_CHG_STATUS  GPIO_19
#define GPIO_IN_AUDIO_JACK_DET1     GPIO_20
#define GPIO_OUT_BOOST_EN          GPIO_21
#define GPIO_IN_DSP_TUNING           GPIO_22

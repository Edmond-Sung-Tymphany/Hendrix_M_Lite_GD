...
static const tGPIOPin gpioPinsForPower[] =
{
    ...
    {GPIO_OUT_AMP_ON, IO_PORT_A, IO_BIT_8, GPIO_DIGITAL_OUTPUT, GPIO_DEFAULT_OUT_FLOATING, ODC_DISABLE},  //AMP ON :PA8
    {GPIO_OUT_WF_MUTE, IO_PORT_B, IO_BIT_7, GPIO_DIGITAL_OUTPUT, GPIO_DEFAULT_OUT_FLOATING, ODC_DISABLE},  //WF MUTE :PB7
    {GPIO_OUT_TW_PWDNN, IO_PORT_B, IO_BIT_6, GPIO_DIGITAL_OUTPUT, GPIO_DEFAULT_OUT_FLOATING, ODC_DISABLE},  //TF PWDNN :PB6
    {GPIO_OUT_TW_FAULT, IO_PORT_F, IO_BIT_0, GPIO_DIGITAL_INPUT, GPIO_ACTIVE_FLOATING, ODC_NOT_APPLICABLE},    //TF FAULT :PF0
    {GPIO_OUT_WF_FAULT, IO_PORT_C, IO_BIT_13, GPIO_DIGITAL_INPUT, GPIO_ACTIVE_FLOATING, ODC_NOT_APPLICABLE},   //WF FAULT :PF0

...
{
    { 0x01, 0xFD }, //Along with register 0x10, 0x11: not clip    FC: init with Shutdown status, FD : init with active status
    { 0x02, 0x14 }, //Digital Boost +6dB, single speed fs (32kHz, 44.1kHz, 48kHz), standard I2S
    { 0x03, 0x80 }, //bit7 is fade on off, bit 1:0 is for mute R  & L
    { 0x04, 0xCF }, //0xCF is 0dB
    { 0x05, 0xCF }, //0xCF is 0dB
    { 0x06, 0x51 },
};
/*    { 0x00, 0x00 },
    { 0x01, 0xFD }, //Along with register 0x10, 0x11: not clip
    { 0x02, 0x14 }, //Digital Boost +6dB, single speed fs (32kHz, 44.1kHz, 48kHz), standard I2S
    { 0x03, 0x80 },
    { 0x04, 0xCF }, //0xCF is 0dB
    { 0x05, 0xCF }, //0xCF is 0dB
    { 0x06, 0xD1 }, //bit7: PBTL for single speaker with two channel pararrel
    { 0x07, 0x00 },
    { 0x08, 0x00 }, //bit3: clock error
    { 0x09, 0x00 },
    { 0x0A, 0x00 },
    { 0x0B, 0x00 },
    { 0x0C, 0x00 },

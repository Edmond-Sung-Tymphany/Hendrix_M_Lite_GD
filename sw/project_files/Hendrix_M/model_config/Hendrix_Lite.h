...
#define BT_VERSION_LENGTH    (10)


#define SW_MAJOR_VERSION      7
#define SW_MINOR_VERSION1    0
#define SW_MINOR_VERSION2    6
...
#define BT_MAJOR_VERSION      7
#define BT_MINOR_VERSION1    0
#define BT_MINOR_VERSION2    6
#define PRODUCT_VERSION_BT       STRINGIFY(BT_MAJOR_VERSION.BT_MINOR_VERSION1.BT_MINOR_VERSION2)

...
typedef enum
{
    ...
    STEADY_PAT_MAX = PULSE_PAT_RED,

    DIM_PAT_MIN,
    /* dim pattern */
    DIM_PATT_RED = DIM_PAT_MIN,

    /* Dim slow flash pattern */
    DIM_SLOW_FLASH_PAT_RED,

    DIM_PAT_MAX = DIM_SLOW_FLASH_PAT_RED,
...
typedef enum _eLedIndID
{
    ...
    /* BT Connectivity */
    LED_IND_ID_BT_CONNECTABLE,
    LED_IND_ID_BT_PAIRING_ENABLED,
    LED_IND_ID_BT_RECONNECTING,
    LED_IND_ID_BT_CONNECTED,
    LED_IND_ID_BT_STREAMING,
    /* BT Connectivity in semi-active state */
    LED_IND_ID_BT_CONNECTABLE_DIM,
    LED_IND_ID_BT_PAIRING_ENABLED_DIM,
    LED_IND_ID_BT_RECONNECTING_DIM,
    LED_IND_ID_BT_CONNECTED_DIM,
    LED_IND_ID_BT_STREAMING_DIM,

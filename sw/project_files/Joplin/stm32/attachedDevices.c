...
#if ((defined JOPLIN_S || defined JOPLIN_M) && defined HW_VER_ES)
    {GPIO_IN_INPUT_KEY, IO_PORT_F,  IO_BIT_0,  GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE},
#else
    {GPIO_IN_INPUT_KEY, IO_PORT_A,  IO_BIT_7,  GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE}, // input source key
#endif
    {GPIO_IN_POWER_KEY, IO_PORT_A,  IO_BIT_2,  GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE}, // power key, PA2
};
...
{
    {GPIO_OUT_IOE_3V3,  IO_PORT_B,  IO_BIT_0,  GPIO_DIGITAL_OUTPUT, GPIO_DEFAULT_OUT_HIGH,    ODC_DISABLE}, //  LED 3.3V : PB0
    {GPIO_IN_POWER_KEY, IO_PORT_A,  IO_BIT_2,  GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE}, // power key, PA2
};
...
#else
    {GPIO_IN_WF_FAULT,   IO_PORT_B,  IO_BIT_6,   GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,              ODC_NOT_APPLICABLE},
#endif

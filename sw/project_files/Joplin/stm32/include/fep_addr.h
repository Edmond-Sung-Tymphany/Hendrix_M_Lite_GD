...
// For STM32F030CC with 256k flash
...
#define FEP_ADDR_BOOT_STATUS        (0x0803FBFC) //4bytes
#define FEP_ADDR_FIRMWARE_STATUS    (0x0803FC00) //4bytes


//Store on FEP_ADDR_STBL_STATUS
typedef enum
{
    FEP_STBL_NORMAL = 0,
    FEP_STBL_NEW,                   // skip BT module power sequence in PIU
...
//Store on FEP_ADDR_FIRMWARE_STATUS
typedef enum
{
    FEP_FIRMWARE_NORMAL = 0,
    FEP_FIRMWARE_POWERED_ASETK,         // powered ASE-TK in PIU
    FEP_FIRMWARE_POWERED_BTM = FEP_FIRMWARE_POWERED_ASETK,         // powered BT module in PIU
    FEP_FIRMWARE_NEW,                   // skip BT module power sequence in Firmware

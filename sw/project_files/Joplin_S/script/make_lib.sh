...
function build_target() 
{
	...
	package_name=${project}_M_hw${hw_ver}_swv${sw_ver}_${date}_${tp_target}
...
function build_start()
{
	...
	#Folder name
	out_folder="Zound_${project}_M_hw${hw_ver}_swv${sw_version}_${date}"
	...
	if [ ${zip_en} == "1" ] && [ ${dsp_auto_build} != "1" ]; then
		...
		"${zip_path}" a "../Zound_${project}_M_hw${hw_ver}_swv${sw_version}_${date}.zip" $(ls -I $tmp_folder)
		# generate md5
		md5sum "../Zound_${project}_M_hw${hw_ver}_swv${sw_version}_${date}.zip" >> "../Zound_${project}_M_hw${hw_ver}_swv${sw_version}_${date}.zip.md5.txt"

		"${zip_path}" a "../Zound_${project}_M_hw${hw_ver}_swv${sw_version}_${date}_backup.zip" "./*"
	fi

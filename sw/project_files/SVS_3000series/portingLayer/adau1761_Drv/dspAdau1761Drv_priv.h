...
#define ADAU1761_MAX_TX_BYTES   256
...
typedef enum
{
    TUNING_RANGE_STANDARD   = 20,
    TUNING_RANGE_EXTENDED   = 16,
...
/* private functions */
static void DspDrv1761_ChkMagicNum(const uint8 *p);
static void DspDrv1761_Delay(uint16 count);
static void DspDrv1761_DispatchDspConfigData(cDSPDrv1761 *me);

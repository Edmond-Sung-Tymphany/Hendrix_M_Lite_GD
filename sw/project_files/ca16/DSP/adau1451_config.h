...
/* Pass through enable */
#define PASS_THROUGH_REGISTER_HIGH_BYTE    (MOD_BYPASS_NX4_1_STEREOMUXSIGMA300NS41INDEX_ADDR >> 8)
#define PASS_THROUGH_REGISTER_LOW_BYTE     (MOD_BYPASS_NX4_1_STEREOMUXSIGMA300NS41INDEX_ADDR & 0xff)

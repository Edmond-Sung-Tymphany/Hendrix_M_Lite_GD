...
static const tGPIOPin gpioKeyPins[] =
{
    ...
    {GPIO_IN_VOL_UP,  IO_PORT_C,  IO_BIT_15,   GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE}, // Connect key, PB3
    {GPIO_IN_VOL_DOWN,IO_PORT_C,  IO_BIT_14,   GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE}, // Connect key, PD2
    {GPIO_IN_CONF,    IO_PORT_C,  IO_BIT_13,   GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE}, // Connect key, PD2
    // {GPIO_IN_VOL        ,   IO_PORT_C,  IO_BIT_15,   GPIO_DIGITAL_INPUT,  GPIO_ACTIVE_LOW,  ODC_NOT_APPLICABLE}, // Connect key, PD2
};
...
{   /* key_id           */
    {VOLUME_UP_KEY,        GPIO_IN_VOL_UP},
    {VOLUME_DOWN_KEY,      GPIO_IN_VOL_DOWN},
    {CONFIG_KEY,           GPIO_IN_CONF},
};
...
{
    {GPIO_IN_AUDIO_JACK_DET,    IO_PORT_A,  IO_BIT_0,   GPIO_DIGITAL_INPUT,     GPIO_ACTIVE_LOW,         ODC_NOT_APPLICABLE}, //AUDIO_JACK_DET1,  PA0
    {GPIO_OUT_SYSPWR_ON,        IO_PORT_B,  IO_BIT_0,   GPIO_DIGITAL_OUTPUT,    GPIO_DEFAULT_OUT_LOW,    ODC_DISABLE},   //PB0
    {GPIO_OUT_AMP_SDZ,          IO_PORT_C,  IO_BIT_9,   GPIO_DIGITAL_OUTPUT,    GPIO_DEFAULT_OUT_LOW,   ODC_DISABLE}, //PB13
    {GPIO_OUT_AMP_MUTE,         IO_PORT_B,  IO_BIT_15,  GPIO_DIGITAL_OUTPUT,    GPIO_DEFAULT_OUT_LOW,    ODC_DISABLE}, //PB13    
};

...
TP_FEATURE  += ENABLE_ACCURATE_DELAY
TP_FEATURE  += ENABLE_WAKEUP_BY_UART
TP_FEATURE  += EXTERNAL_AND_INTERNAL_HIGH_SPEED_CLOCK
TP_FEATURE  += HAS_BATTERY
TP_FEATURE  += EXTERNAL_BATTERY
TP_FEATURE  += HAS_POWER_DELEGATE
TP_FEATURE  += USE_POWER_SNEAKY_SERVER
TP_FEATURE  += REMEMBER_VOLUME
TP_FEATURE  += AUDIO_MULTI_SOURCE
TP_FEATURE  += BT_AUDIO_HAS_HIGH_PRIO
TP_FEATURE  += AUDIO_LIMITER_FOR_LOW_POWER
TP_FEATURE  += HAS_BT_TONE
TP_FEATURE  += BT_NFC_PAIR
TP_FEATURE  += HAS_BT_DELEGATE
TP_FEATURE  += HAS_ROM_BASE_BT
TP_FEATURE  += BT_CODEC_STATUS_CHECK
TP_FEATURE  += HAS_NVM
TP_FEATURE  += HAS_DEBUGSETT
TP_FEATURE  += DEBUG_BATT_INFO
TP_FEATURE  += HAS_I2C
TP_FEATURE  += LED_HAS_IOEXPANDER

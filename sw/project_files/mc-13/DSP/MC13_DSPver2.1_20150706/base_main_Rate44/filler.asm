...
.endcodeblock
.coeff_miniDSP_D MinusOne_Int =-1 $common
.coeff_miniDSP_D Anonymous_Block_3_Count =131
.codeblock Anonymous_Block_3 cycles=268, mincycle=628, maxcycle=895, target=miniDSP_D
acc_init Anonymous_Block_3_Count data_one ; Acc = N (start a delay loop)
nop
Anonymous_Block_3_NopLoop:
acc      MinusOne_Int data_one  ; Acc = N-1
jump     jmp_sz Anonymous_Block_3_NopLoop 133 ; stop when loop iterates n+2 times 
.endcodeblock

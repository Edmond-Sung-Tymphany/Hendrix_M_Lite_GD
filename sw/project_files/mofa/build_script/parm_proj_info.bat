...
::Version
set PRJ_NAME=MOF_AP
set SAM_VER=2.0.34-S
set SAM_THEME=mofa-theme
set HW_VER=EVT
...
set DTB_MAIN_FN_DEBUG=MOF_AP_Debug
set DTB_MAIN_FN_DBG_R=MOF_AP_Repeat
set DTB_MAIN_FN_RELEA=MOF_AP_Release
...
set UPDATE_IMG_URL_BASE_DEBUG=http:\/\/10.13.3.199\/allplay\/eng\/danielq\/mofa\/fw_debug
set UPDATE_IMG_URL_BASE_DBG_R=http:\/\/10.13.3.199\/allplay\/eng\/danielq\/mofa\/fw_test
set UPDATE_IMG_URL_BASE_RELEA=https:\/\/www.thehouseofmarley.com\/upgrade\/onefoundation\/release
...
set PATH_DTB=%~dp0\..\mofa_dts_files

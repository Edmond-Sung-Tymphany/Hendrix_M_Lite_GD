...
#define     ADC_NTC_POWER_DETECT  ADC_PIN9  //PB1

//Audio
#define GPIO_IN_AUDIO_JACK_DET1     GPIO_25 //Johnson Added  2016-06-22
#define GPIO_AMP_MUTE   GPIO_26
#define GPIO_IN_AUDIO_DETECT  GPIO_27
...
#define NUM_OF_LINEAR_KNOB_KEY          0
#define NUM_OF_GPIO_KEY              2
#define NUM_OF_GPIO_DECODER_KEY         1
#define NUM_OF_ALL_KEY                  (NUM_OF_ADC_KEY + NUM_OF_GPIO_KEY + NUM_OF_LINEAR_KNOB_KEY + NUM_OF_GPIO_DECODER_KEY)

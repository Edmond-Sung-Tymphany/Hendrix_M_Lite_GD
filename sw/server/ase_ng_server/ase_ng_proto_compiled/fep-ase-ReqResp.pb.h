...
typedef enum _Proto_FepAse_ReqResp {
    ...
    Proto_FepAse_ReqResp_PLAY_AUDIO_CUE = 28
} Proto_FepAse_ReqResp;
#define _Proto_FepAse_ReqResp_MIN Proto_FepAse_ReqResp_PING
#define _Proto_FepAse_ReqResp_MAX Proto_FepAse_ReqResp_PLAY_AUDIO_CUE
#define _Proto_FepAse_ReqResp_ARRAYSIZE ((Proto_FepAse_ReqResp)(Proto_FepAse_ReqResp_PLAY_AUDIO_CUE+1))

...
#endif
static void DebugSrvAllplayPlayerStateOutput(QEvt const * const e);
...
static char in_buf[CLI_INPUT_BUFFER_SIZE] = {};
...
static QState DebugSrv_Ready(cDebugSrv * const me, QEvt const * const e)
{
    ...
    {
        DebugSrvAllplayPlayerStateOutput(e);
        return Q_RET_HANDLED;
    }
...
static void DebugSrvAllplayPlayerStateOutput(QEvt const * const e)
{
    AllPlayStateIndEvt* apstate = (AllPlayStateIndEvt*) e;
#ifndef NDEBUG
	switch (apstate->allPlayState)
    {
    case ALLPLAY_STATE_PLAYER_UNKNOWN:
        DebugSrvOutput("\r\n<<<ALLPLAY_PLAYER_STATE_UNKNOWN>>>\r\n",0);
        break;
    case ALLPLAY_STATE_PLAYER_STOPPED:
        DebugSrvOutput("\r\n<<<ALLPLAY_PLAYER_STATE_STOPPED>>>\r\n",0);
        break;
    case ALLPLAY_STATE_PLAYER_TRANSITIONING:
        DebugSrvOutput("\r\n<<<ALLPLAY_PLAYER_STATE_TRANSITIONING>>>\r\n",0);
        break;
    case ALLPLAY_STATE_PLAYER_BUFFERING:
        DebugSrvOutput("\r\n<<<ALLPLAY_PLAYER_STATE_BUFFERING>>>\r\n",0);
        break;
    case ALLPLAY_STATE_PLAYER_PLAYING:
        DebugSrvOutput("\r\n<<<ALLPLAY_PLAYER_STATE_BUFFERING>>>\r\n",0);
        break;
    case ALLPLAY_STATE_PLAYER_PAUSED:
        DebugSrvOutput("\r\n<<<ALLPLAY_PLAYER_STATE_PAUSED>>>\r\n",0);
        break;
    default:
        break;
    }
    ...
    {
    case ALLPLAY_STATE_PLAYER_UNKNOWN:
        pt_handle_indication_1b((get_current_seq()+1), PT_COMMAND_ALLPLAY_PLAYER_STATE, PT_INDICATION_ALLPLAY_PLAYER_STATE_UNKNOWN );
        break;
    case ALLPLAY_STATE_PLAYER_STOPPED:
        pt_handle_indication_1b((get_current_seq()+1), PT_COMMAND_ALLPLAY_PLAYER_STATE, PT_INDICATION_ALLPLAY_PLAYER_STATE_STOPPED );
        break;
    case ALLPLAY_STATE_PLAYER_TRANSITIONING:
        pt_handle_indication_1b((get_current_seq()+1), PT_COMMAND_ALLPLAY_PLAYER_STATE, PT_INDICATION_ALLPLAY_PLAYER_STATE_TRANSITIONING );
        break;
    case ALLPLAY_STATE_PLAYER_BUFFERING:
        pt_handle_indication_1b((get_current_seq()+1), PT_COMMAND_ALLPLAY_PLAYER_STATE, PT_INDICATION_ALLPLAY_PLAYER_STATE_BUFFERING );
        break;
    case ALLPLAY_STATE_PLAYER_PLAYING:
        pt_handle_indication_1b((get_current_seq()+1), PT_COMMAND_ALLPLAY_PLAYER_STATE, PT_INDICATION_ALLPLAY_PLAYER_STATE_PLAYING );
        break;
    case ALLPLAY_STATE_PLAYER_PAUSED:
        pt_handle_indication_1b((get_current_seq()+1), PT_COMMAND_ALLPLAY_PLAYER_STATE, PT_INDICATION_ALLPLAY_PLAYER_STATE_PAUSED );
        break;
    default:
        break;
    }
